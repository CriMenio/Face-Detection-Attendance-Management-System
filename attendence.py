...
#Send the captured image to AWS S3 Bucket--------------------------------------------------------------------------------------
    clients3 = boto3.client('s3', aws_access_key_id="AKIA2EQFXUWZWLJG6WTR",
                      aws_secret_access_key="05K61SpmHdfXk1Jt0BSxz8jZihF2MezaGBQWN+s1", region_name='ap-south-1')
    # clients3.upload_file("Hourly Class Images/"+current_time+'.jpg', 'add your S3 bucket name', current_time+'.jpg')

    clients3.upload_file("img/" + current_time + '.jpg', 'attendance-management-system-13579', current_time + '.jpg')
    ...
    #Update the Rokognition ARN with yours   
        ...
        ProjectVersionArn='arn:aws:rekognition:ap-south-1:696870479283:project/AttendanceSystem/version/AttendanceSystem.2023-07-06T15.49.54/1688638795363',
    ...
    if not len(response['CustomLabels']):
        ...
        url = "https://lfe3trprkc.execute-api.ap-south-1.amazonaws.com/default/AttendFunction?Name=" + str
